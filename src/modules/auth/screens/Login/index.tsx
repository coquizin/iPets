        ...
        <form onSubmit={handleSubmit(onSubmit)} className="w-full ">
          <div className="flex flex-col items-center w-full mt-10 space-y-4">
            ...
            <div className="flex flex-col items-center justify-center w-full gap-5">
              <button
                className="md:max-w-[400px] max-w-[300px] w-full flex items-center justify-center h-[62px]  text-black duration-200 rounded-md bg-yellow-500 shadow-lg hover:shadow-none border-gray-800  text-lg font-semibold uppercase"
                type="submit"
              >
                Entrar
              </button>
